...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1"><?php echo e($entityTitle); ?></h1>
        <p class="text-muted mb-0"><?php echo e($entityDescription); ?></p>
    </div>
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#entityModal" id="btn-create">
        <i class="bi bi-plus-lg me-1"></i> New <?php echo e(rtrim($entityTitle, 's')); ?>
    ...
    <div class="modal-dialog modal-lg">
        <form class="modal-content" id="entity-form">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title"><?php echo e(rtrim($entityTitle, 's')); ?></h5>
...
<script>
(() => {
    const apiBase = <?php echo json_encode($apiBase ?? '/api/identities', 15, 512) ?>;
    const config = <?php echo json_encode($config, 15, 512) ?>;
