...
<script>
(() => {
    const apiBase = <?php echo json_encode($apiBase ?? '/api/users', 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\AxiomOS\axiomos-core\modules\Users\Resources\views/users/index.blade.php ENDPATH**/ ?>