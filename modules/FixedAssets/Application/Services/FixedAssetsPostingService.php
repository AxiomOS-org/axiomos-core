...
namespace Modules\FixedAssets\Application\Services;
...
final class FixedAssetsPostingService {
    public function __construct(private readonly PostingEngineInterface $posting, private readonly DepreciationRunRepositoryInterface $documents) {}
    public function submit(array $payload): array {
        ...
        $result = $this->posting->submit(new PostingRequest(
            (string) ($payload['idempotency_key'] ?? uniqid('assets:', true)),
            'FixedAssets',
            (string) ($payload['document_type'] ?? 'assets_document'),
