...
final class SalesPostingService {
    public function __construct(private readonly PostingEngineInterface $posting, private readonly SalesInvoiceRepositoryInterface $documents) {}
    public function submit(array $payload): array {
        ...
        $result = $this->posting->submit(new PostingRequest(
            (string) ($payload['idempotency_key'] ?? uniqid('sales:', true)),
            'Sales',
            (string) ($payload['document_type'] ?? 'sales_document'),
