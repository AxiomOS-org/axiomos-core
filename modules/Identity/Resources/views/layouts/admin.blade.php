...
<head>
    ...
    <title>{{ $title ?? 'AxiomOS Identity' }}</title>
...
<div class="d-flex">
    <aside class="sidebar position-fixed top-0 start-0 py-3">
        ...
        <nav class="nav flex-column">
            <a class="nav-link {{ ($active ?? '') === 'dashboard' ? 'active' : '' }}" href="/identity/dashboard"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
            <a class="nav-link {{ ($active ?? '') === 'identities' ? 'active' : '' }}" href="/identity/identities"><i class="bi bi-person-badge me-2"></i>Identities</a>
            ...
            <a class="nav-link {{ ($active ?? '') === 'teams' ? 'active' : '' }}" href="/identity/teams"><i class="bi bi-diagram-2 me-2"></i>Teams</a>
            <a class="nav-link {{ ($active ?? '') === 'team-members' ? 'active' : '' }}" href="/identity/team-members"><i class="bi bi-people-fill me-2"></i>Team Members</a>
            <a class="nav-link {{ ($active ?? '') === 'employee-profiles' ? 'active' : '' }}" href="/identity/employee-profiles"><i class="bi bi-file-earmark-person me-2"></i>Profiles</a>
            <a class="nav-link {{ ($active ?? '') === 'contacts' ? 'active' : '' }}" href="/identity/contacts"><i class="bi bi-telephone me-2"></i>Contacts</a>
            <a class="nav-link {{ ($active ?? '') === 'devices' ? 'active' : '' }}" href="/identity/devices"><i class="bi bi-laptop me-2"></i>Devices</a>
            <a class="nav-link {{ ($active ?? '') === 'identity-sessions' ? 'active' : '' }}" href="/identity/identity-sessions"><i class="bi bi-door-open me-2"></i>Sessions</a>
            <a class="nav-link {{ ($active ?? '') === 'login-history' ? 'active' : '' }}" href="/identity/login-history"><i class="bi bi-clock-history me-2"></i>Login History</a>
...
<div class="d-flex">
    <aside class="sidebar position-fixed top-0 start-0 py-3">
        ...
        <nav class="nav flex-column">
            <a class="nav-link {{ ($active ?? '') === 'dashboard' ? 'active' : '' }}" href="/identity/dashboard"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
            <a class="nav-link {{ ($active ?? '') === 'identities' ? 'active' : '' }}" href="/identity/identities"><i class="bi bi-person-badge me-2"></i>Identities</a>
            <a class="nav-link {{ ($active ?? '') === 'users' ? 'active' : '' }}" href="/users"><i class="bi bi-people me-2"></i>Users</a>
            <a class="nav-link {{ ($active ?? '') === 'memberships' ? 'active' : '' }}" href="/memberships"><i class="bi bi-person-lines-fill me-2"></i>Memberships</a>
            <a class="nav-link {{ ($active ?? '') === 'org-links' ? 'active' : '' }}" href="/organizations"><i class="bi bi-diagram-3 me-2"></i>Org Links</a>
        </nav>
