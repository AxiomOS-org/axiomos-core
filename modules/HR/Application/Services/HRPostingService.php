...
final class HRPostingService {
    public function __construct(private readonly PostingEngineInterface $posting, private readonly PayrollRunRepositoryInterface $documents) {}
    public function submit(array $payload): array {
        ...
        $result = $this->posting->submit(new PostingRequest(
            (string) ($payload['idempotency_key'] ?? uniqid('hr:', true)),
            'HR',
            (string) ($payload['document_type'] ?? 'hr_document'),
