...
<div class="d-flex">
    <aside class="sidebar position-fixed top-0 start-0 py-3">
        <div class="px-3 mb-4">
            ...
            <div class="small text-secondary mt-1">HR Foundation</div>
        </div>
        <nav class="nav flex-column">
            <a class="nav-link {{ ($active ?? '') === 'dashboard' ? 'active' : '' }}" href="/hr/dashboard"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
            <a class="nav-link {{ ($active ?? '') === 'accounts' ? 'active' : '' }}" href="/hr/accounts"><i class="bi bi-journal-text me-2"></i>Chart of Accounts</a>
            <a class="nav-link {{ ($active ?? '') === 'documents' ? 'active' : '' }}" href="/hr/documents"><i class="bi bi-file-earmark-text me-2"></i>Documents</a>
            <a class="nav-link {{ ($active ?? '') === 'journals' ? 'active' : '' }}" href="/hr/journals"><i class="bi bi-receipt me-2"></i>Journals</a>
            <a class="nav-link {{ ($active ?? '') === 'fiscal-years' ? 'active' : '' }}" href="/hr/fiscal-years"><i class="bi bi-calendar-range me-2"></i>Fiscal Years</a>
            <a class="nav-link {{ ($active ?? '') === 'periods' ? 'active' : '' }}" href="/hr/periods"><i class="bi bi-calendar3 me-2"></i>Periods</a>
