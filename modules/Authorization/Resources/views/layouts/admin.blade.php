...
<head>
    ...
    <title>{{ $title ?? 'AxiomOS Security' }}</title>
...
<div class="d-flex">
    <aside class="sidebar position-fixed top-0 start-0 py-3">
        ...
        <nav class="nav flex-column">
            <a class="nav-link {{ ($active ?? '') === 'dashboard' ? 'active' : '' }}" href="/security/dashboard"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
            <a class="nav-link {{ ($active ?? '') === 'roles' ? 'active' : '' }}" href="/security/roles"><i class="bi bi-shield-lock me-2"></i>Roles</a>
            <a class="nav-link {{ ($active ?? '') === 'permissions' ? 'active' : '' }}" href="/security/permissions"><i class="bi bi-key me-2"></i>Permissions</a>
            <a class="nav-link {{ ($active ?? '') === 'sessions' ? 'active' : '' }}" href="/security/sessions"><i class="bi bi-door-open me-2"></i>Sessions</a>
            <a class="nav-link {{ ($active ?? '') === 'login-history' ? 'active' : '' }}" href="/security/login-history"><i class="bi bi-clock-history me-2"></i>Login History</a>
