...
final class MembershipPlatformHooks
{
    ...
    {
        $this->audit->record($entity, 'created', null, $entity instanceof AuditableInterface ? $entity->toAuditSnapshot() : null);
        $this->activities->record($entity, ActivityType::Created, 'Record created', null, null, ['entity_type' => $entity->getEntityType()]);
        $this->aiContext->upsert($entity, 'default', ['entity_type' => $entity->getEntityType(), 'summary' => 'New ERP record']);
