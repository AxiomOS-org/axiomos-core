...
final class ManufacturingPostingService {
    public function __construct(private readonly PostingEngineInterface $posting, private readonly ProductionRunRepositoryInterface $documents) {}
    public function submit(array $payload): array {
        ...
        $result = $this->posting->submit(new PostingRequest(
            (string) ($payload['idempotency_key'] ?? uniqid('manufacturing:', true)),
            'Manufacturing',
            (string) ($payload['document_type'] ?? 'manufacturing_document'),
