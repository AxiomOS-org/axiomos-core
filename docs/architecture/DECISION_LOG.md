...
| ADR-011 | 2026-07-02 | Rule 0: No AI generates production code directly | AI speed must not bypass governance pipeline | Direct AI-to-file coding | Long-term quality and auditability across all modules | Accepted |
